...
public class A2021_02 {
    ...
    private static final JList<String> EXAMPLE = JList.of(
            "forward 5",
            "down 5",
            "forward 8",
            "up 3",
