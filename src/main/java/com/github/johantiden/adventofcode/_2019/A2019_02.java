...
public class A2019_02 {
    ...
    public static void main(String[] args) {
        ...
        IntcodeComputer.of(memory, null, null).run();
        ...
        public static void main(String[] args) {
            ...
            for (int noun = 0; noun < 99; noun++) {
                for (int verb = 0; verb < 99; verb++) {
                    ...
                    new IntcodeComputer(IntcodeComputer.Memory.of(memory), null, null).run();
                    long response = memory[0];
